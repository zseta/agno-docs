...
|----------|--------|----------|-----------------------|
| Image | `from agno.media import Image` | `images=[Image(url=...)]` | `google:gemini-3.5-flash` |
| Audio | `from agno.media import Audio` | `audio=[Audio(content=...)]` | `google:gemini-3.5-flash` |
| Video | `from agno.media import Video` | `videos=[Video(content=..., format="mp4")]` | `google:gemini-3.5-flash` |
| PDF | `from agno.media import File` | `files=[File(url=...)]` | `google:gemini-3.5-flash` |

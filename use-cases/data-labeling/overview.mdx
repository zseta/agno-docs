...
Here's how simple text classification is. Just add `output_schema` and the agent returns data in that format. Give your agent tools to search usage and internal data to add more details.

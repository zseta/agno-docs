...
Agno supports 45+ model providers. Switching models within the same provider is safe. Switching between providers on the same session can break because stored message history formats differ between providers.

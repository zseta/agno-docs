...
**Cause:** Authorization is preferred over security key. When both are enabled, security key requests fail. See [security key authentication](/agent-os/security/overview#security-key).

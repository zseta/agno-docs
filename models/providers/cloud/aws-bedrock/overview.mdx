...
| `append_trailing_user_message` | `Optional[bool]` | `None`                                       | Append a trailing user message when the conversation ends with an assistant message. Defaults based on whether the model supports assistant message prefill.              |

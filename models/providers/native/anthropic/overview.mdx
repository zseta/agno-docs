...
- `claude-sonnet-4-5-20250929` is the Agno default and good for most use-cases. It supports image input and structured outputs.
- `claude-opus-4-8` is their most capable Opus model.
- `claude-haiku-4-5` is their fastest model.
...
Set your `ANTHROPIC_API_KEY` environment variable. You can get one [from Anthropic here](https://console.anthropic.com/settings/keys).

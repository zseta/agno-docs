...
### LangDB Capabilities
- **Virtual Models**: Save, share, and reuse model configurations. Each one combines prompts, parameters, tools, and routing logic into a single named unit for consistent behavior across apps

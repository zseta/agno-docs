...
model call becomes a span you can inspect, search, and evaluate. Token
usage, cost, latency, and full input/output are captured automatically.
...
Instrument your Agno agent with OpenInference and send traces to Latitude's

...
Full source: [cookbook/05_agent_os/mcp_demo/mcp_tools_example.py](https://github.com/agno-agi/agno/blob/main/cookbook/05_agent_os/mcp_demo/mcp_tools_example.py)

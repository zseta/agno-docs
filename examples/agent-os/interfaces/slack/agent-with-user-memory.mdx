...
description: "A personal assistant that remembers users across conversations using ``MemoryManager``."
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U "agno[os,slack]" anthropic ddgs fastmcp openai starlette
    ```
  </Step>

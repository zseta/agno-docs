...
description: "This example demonstrates a human-controlled Condition."
source: cookbook/05_agent_os/human_in_the_loop/workflow/condition_user_decision.py
---

This example demonstrates a human-controlled Condition. Confirming runs the primary branch; rejecting runs the else branch.

...
description: "This example demonstrates multiple sequential human decisions in one workflow."
source: cookbook/05_agent_os/human_in_the_loop/workflow/decision_tree.py
---

This example demonstrates multiple sequential human decisions in one workflow. Each Condition pauses in AgentOS and the selected branch shapes the final output.

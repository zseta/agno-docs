...
Full source: [cookbook/02_agents/09_hooks/message_history_hooks.py](https://github.com/agno-agi/agno/blob/main/cookbook/02_agents/09_hooks/message_history_hooks.py)

...
description: "Examples of using Docling to process spreadsheet and data files."
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code blocks above as `docling_xlsx.py` and `utils.py` in the same directory, then run:
    ```bash
    python docling_xlsx.py
    ```
  </Step>

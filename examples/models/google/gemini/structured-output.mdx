...
Full source: [cookbook/90_models/google/gemini/structured_output.py](https://github.com/agno-agi/agno/blob/main/cookbook/90_models/google/gemini/structured_output.py)

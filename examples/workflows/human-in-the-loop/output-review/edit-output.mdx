...
description: "This example demonstrates human editing of step output using the HITL config."
source: cookbook/04_workflows/08_human_in_the_loop/output_review/03_edit_output.py
---

This example demonstrates human editing of step output using the HITL config. Instead of rejecting and retrying (which costs another LLM call), the human directly modifies the output before it flows to the next step.

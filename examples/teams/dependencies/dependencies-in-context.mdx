...
Full source: [cookbook/03_teams/17_dependencies/dependencies_in_context.py](https://github.com/agno-agi/agno/blob/main/cookbook/03_teams/17_dependencies/dependencies_in_context.py)

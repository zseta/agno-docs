...
Full source: [cookbook/03_teams/20_human_in_the_loop/confirmation_required_async_stream.py](https://github.com/agno-agi/agno/blob/main/cookbook/03_teams/20_human_in_the_loop/confirmation_required_async_stream.py)

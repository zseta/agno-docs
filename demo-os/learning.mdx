...
A useful agent gets sharper the more you use it. The first time you ask for something, it answers from generic patterns. The fifth time, it follows your conventions. The twentieth time, it's predicting what you'll need before you ask.

That compounding behavior comes from `LearningMachine`. Four agents in the demo use it.

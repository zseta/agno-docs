...
The lines blur, but the rule of thumb: dependencies are read-only and ephemeral. Memory and knowledge are persistent. Session state is mutable but session-scoped.
...
Next: [Session State →](/demo-os/session-state)

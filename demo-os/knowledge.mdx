...
`Knowledge` is the retrieval primitive. Vector index, optional keyword index, optional reranker. Pal and Dash both use it heavily.
...
The vector DB returns top-50, the reranker scores them, the top-10 reach the model. This is the standard production pattern: cast wide, rerank tight.
...
Source: [`agents/pal/`](https://github.com/agno-agi/demo-os/tree/main/agents/pal), [`agents/dash/`](https://github.com/agno-agi/demo-os/tree/main/agents/dash), [Knowledge docs](/knowledge/overview)

Next: [Memory →](/demo-os/memory)

...
The script provisions Postgres, configures env vars, and ships the app. Same pattern as the [Scout](/deploy/templates/scout/overview), [Dash](/deploy/templates/dash/overview), and [Coda](/deploy/templates/coda/overview) deploys.

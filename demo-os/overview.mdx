...
The script provisions Postgres, configures env vars, and ships the app. Same pattern as the [Scout](/tutorials/scout/deploy-to-railway), [Dash](/tutorials/dash/deploy-to-railway), and [Coda](/deploy/templates/coda/overview) deploys.

...
[Pal](https://github.com/agno-agi/demo-os/tree/main/agents/pal) and [Dash](https://github.com/agno-agi/demo-os/tree/main/agents/dash) both use retrieval to ground answers. Different problems, same primitive.
...
Next: [Knowledge →](/demo-os/knowledge)

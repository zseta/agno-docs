...
When you give an agent access to a knowledge base, it gains several capabilities:

### Automatic Information Retrieval
The agent automatically determines when additional information would help answer a question or complete a task. Explicitly instructing the agent to search the knowledge base is also a common pattern.
...
The agent understands the context of questions and searches by meaning rather than keyword matches.
...
<CardGroup cols={3}>
  ...
  <Card title="Search & Retrieval" icon="magnifying-glass" href="/knowledge/concepts/search-and-retrieval/overview">
    How agents search and retrieve relevant information
  </Card>

...
This example implements traditional RAG using the LanceDB vector database. Knowledge is added to context up front rather than searched dynamically by the agent.

...
Agentic RAG using PgVector (PostgreSQL with vector extensions) for storing and searching embeddings with hybrid search.
...
2. Run: `pip install openai sqlalchemy 'psycopg[binary]' pgvector pypdf agno` to install the dependencies

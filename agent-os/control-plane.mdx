...
Toggle JWT verification on or off from the Settings page. Generate key pairs and configure RBAC without leaving the control plane.
...
<Frame>
  <video
    ...
    style={{ borderRadius: "0.5rem", width: "100%", height: "auto" }}
  >
    <source src="/videos/auth-from-settings-web.mp4" type="video/mp4" />
  </video>
</Frame>

See [AgentOS Security](/agent-os/security/overview) for setup details.

...
<Note>
RBAC requires JWT authentication. Without it, os-level scopes assigned in the control plane do not reach AgentOS and every request is treated as unauthenticated.
</Note>

...
AgentOS validates the JWT on every request, then checks its scopes against the permissions required for each endpoint. Control who can access and run your agents, teams, and workflows.

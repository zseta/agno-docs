...
Set `OS_SECURITY_KEY` in your `.env` file:
```bash
...
Copy your public verification key and set it as `JWT_VERIFICATION_KEY` in your `.env` file:
```bash
JWT_VERIFICATION_KEY="your-public-key"
```

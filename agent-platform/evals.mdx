...
Evals are regression tests for your agents. Same prompts, same agents, run on a schedule. Notify when behavior drifts.
...
<Steps>
  <Step title="Create a virtual environment">
    ...
    To run the eval suite, create a local virtual environment:

...
Because the platform is unified, coding agents can manage it end-to-end. The codebase ships five skills in `.agents/skills/` that cover the full lifecycle: create → improve → evaluate → maintain.

...
I've curated a set of prompts that you can give your coding agent to build the entire system for you. Pick your cloud, copy the prompt into Claude Code, Cursor or Codex, and it'll take you from zero to a running platform:

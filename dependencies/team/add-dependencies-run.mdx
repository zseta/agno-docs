...
description: Add dependencies to a specific team run. Dependencies are functions that provide contextual information, like user profiles, to the team during execution.
mode: wide
---

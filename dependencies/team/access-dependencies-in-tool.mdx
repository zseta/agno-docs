...
description: Access dependencies passed to the team from inside a tool, giving team members shared dynamic context like team metrics and the current time.
mode: wide
---

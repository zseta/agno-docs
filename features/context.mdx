...
Writable providers (Database, Slack, GitHub) internally run two sub-agents with minimum privilege per role:
...
<Card title="Scout" icon="rocket" href="/tutorials/scout/overview">
  Open-source company intelligence agent. Navigates live information sources (web, Slack, Drive, wiki, CRM, MCP servers) to assemble context on demand. Builds its own wiki and CRM as it learns.
</Card>

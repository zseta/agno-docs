...
The [Scout](/tutorials/scout/connect-slack), [Dash](/tutorials/dash/connect-slack), and [Coda](/deploy/templates/coda/overview) tutorials use this pattern. Slack only loads when both env vars are set, so dev runs without credentials don't crash.

...
Reasoning models deeply consider and think through a plan **before they start generating a response**. They excel at single-shot use cases: hard problems (coding, math, physics) that don't require multiple turns or sequential tool calls.

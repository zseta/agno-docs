...
Fly's stock `postgres-flex` image does not ship pgvector. Sessions and memory work; knowledge bases (RAG) fail at `CREATE EXTENSION` time. Build a derivative image:

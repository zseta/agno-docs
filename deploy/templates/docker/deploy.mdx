...
| Claude and ChatGPT apps | Hosted sessions can't reach localhost. Run in production first, then register `https://<your-public-url>/mcp` as a remote MCP server; sign-in uses OAuth. |

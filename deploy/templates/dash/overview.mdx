...
Dash is public at [agno-agi/dash](https://github.com/agno-agi/dash). The README covers the full architecture: the five engineering layers, the data model, and the security setup.

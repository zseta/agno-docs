...
Two paths run in parallel. The **online path** answers questions using retrieved context; the **offline path** captures learnings for future queries. Dash stores knowledge and learnings in two systems:

...
Dash reasons about what makes an answer useful. Ask "Which plan has the highest churn rate?" and a bare SQL agent returns one number. Dash returns the number with the comparison across plans, the trend behind it, and any caveats from your business rules.

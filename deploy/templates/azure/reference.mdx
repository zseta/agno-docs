...
Run it again. Generated names (`AZURE_ACR_NAME`, `AZURE_PG_NAME`) and `DB_PASS` persist in your env file, and the script reuses the existing Postgres server and Container Apps environment instead of recreating them.
  </Accordion>

...
Coda learns and improves with use, powered by Agno's [Learning Machine](/learning/overview). It picks up your coding standards, conventions, and patterns:
...
Each Slack thread is its own conversation. Follow-ups in the same thread don't need to @mention Coda again.

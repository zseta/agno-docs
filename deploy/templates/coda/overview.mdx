...
Coda learns and improves with use through Agno's [Learning Machine](/learning/overview). It picks up your coding standards, conventions, and patterns:
...
Create a fine-grained GitHub Personal Access Token with Contents (read/write), Pull Requests (read/write), Issues (read/write), and Metadata (read) permissions. Add it to `.env`:

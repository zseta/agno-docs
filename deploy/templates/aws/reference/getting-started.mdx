...
<Warning>
  [HTTPS](/deploy/templates/aws/go-live/https) is required to connect to
  os.agno.com. You'll set this up after deployment.
</Warning>
...
<CardGroup cols={3}>
  <Card
    ...
    icon="gear"
    href="/deploy/templates/aws/reference/configure/settings"
  >
  ...
  <Card
    ...
    icon="key"
    href="/deploy/templates/aws/reference/connect"
  >

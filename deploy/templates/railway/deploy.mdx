...
AgentOS is a secure, scalable backend for running agents. Build agents once and making them available everywhere:
...
3. **Coding agents.** Let Claude Code and Codex run your platform using skills.
...
5. **AgentOS UI.** Chat with agents, inspect sessions, traces, memory, and evals from the control plane at [os.agno.com](https://os.agno.com).

<Frame>
  <img
    src="/images/local-agentos.png"
...
The [agentos-railway](https://github.com/agno-agi/agentos-railway) template let's you run AgentOS + Postgres locally using Docker and deploy to production on Railway. It comes with two platform agents and 5 coding agent skills.

| Agent | Role |
|-------|------|
| **Agent Builder** | Creates agents, teams, and workflows for you. |
| **Platform Manager** | Manages your agent platform for you. |
